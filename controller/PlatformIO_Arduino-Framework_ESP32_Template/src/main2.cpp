...
// // Chân kết nối L298N
// // 2 front wheel
// const int ENA = 5;   // Chân PWM điều khiển tốc độ
// const int ENB = 6;
// const int IN1 = 7;  // Chân điều khiển chiều quay
// const int IN2 = 8;
// const int IN3 = 9;
// const int IN4 = 10;

// // 2 back wheel
// const int ENA_BACK = 17;
// const int ENB_BACK = 18;
// const int IN1_BACK = 21;
// const int IN2_BACK = 38;
// const int IN3_BACK = 47;
// const int IN4_BACK = 48;
