...
if("TRUE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /home/aclab/Desktop/ROS-VR/catkin_ws/src/ydlidar)
  set(ydlidar_DEVEL_PREFIX /home/aclab/Desktop/ROS-VR/catkin_ws/devel/.private/ydlidar)
  set(ydlidar_INSTALL_PREFIX "")
  set(ydlidar_PREFIX ${ydlidar_DEVEL_PREFIX})
else()
  set(ydlidar_SOURCE_PREFIX "")
  set(ydlidar_DEVEL_PREFIX "")
  set(ydlidar_INSTALL_PREFIX /home/aclab/Desktop/ROS-VR/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aclab/Desktop/ROS-VR/catkin_ws/src/ydlidar/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ydlidar_NUM_DUMMY_TARGETS)
      set(ydlidar_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ydlidar::wrapped-linker-option${ydlidar_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ydlidar_NUM_DUMMY_TARGETS "${ydlidar_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ydlidar::wrapped-linker-option${ydlidar_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ydlidar_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aclab/Desktop/ROS-VR/catkin_ws/devel/.private/ydlidar/lib;/home/aclab/Desktop/ROS-VR/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ydlidar_EXPORTED_TARGETS ${${ydlidar_dep}_EXPORTED_TARGETS})
endforeach()
